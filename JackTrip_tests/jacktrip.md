...
Type=idle
Restart=always
ExecStart=/home/patch/sources/jacktrip/builddir/jacktrip -s --clientname mpu005.local
...
Type=idle
Restart=always
ExecStart=/home/patch/sources/jacktrip/builddir/jacktrip -c mpu003.local --clientname mpu005.local
...
- For JackTrip (jack_delay running on the server):
  - on the server:
    - `jack_connect system:playback_2 mpu005.local:receive_2`
    - `jack_connect system:capture_2 mpu005.local:send_2`
  - on the client:
    - `jack_connect system:playback_2 mpu003:receive_2`
    - `jack_connect system:capture_2 mpu003:send_2`
- run the test: `jack_delay -O mpu005.local:send_2 -I mpu005.local:receive_2`
